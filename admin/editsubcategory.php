...
$query=mysqli_query($con,"update subcategory set CategoryId='$categoryid',Subcategory='$subcatname' where SubCategoryId='$subcatid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>Astu website | Edit Sub Category</title>
