...
{
$decryptedId = base64_decode($_GET['said']);
...
$query=mysqli_query($con,"Update admintbl set AdminEmail='$email', AdminUserName='$username', AdminPassword='$newhashedpass'  where id='$decryptedId'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>Astu website |Edit Subadmin</title>
...
<?php 
$decryptedId = base64_decode($_GET['said']);
$query=mysqli_query($con,"Select * from  admintbl where id='$decryptedId'");
$cnt=1;
...
?>
                        		...
                        		<form class="form-horizontal" name="suadmin" method="post">
	                                   ...
	                                   <div class="col-md-10">
	                                       <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminUserName']);?>" name="adminusername">
	                                                </div>
	                                            </div>
            ...
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmail']);?>" name="email" required>
           </div>
           </div>
           <div class="form-group">
