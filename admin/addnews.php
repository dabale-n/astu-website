...
$status=1;
$query=mysqli_query($con,"insert into news (NewsTitle,PostDetails,PostUrl,Is_Active,PostImage,postedBy) values('$posttitle','$postdetails','$url','$status','$imgnewfile','$postedby')");
if($query)
{
...
<input type="text" class="form-control" id="posttitle" name="posttitle" placeholder="Enter title" required>
    ...
    <div class="row">
     ...
     <button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Save and Post News</button>                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
                        </div>
